...
const config = {
  SESSION_ID: process.env.SESSION_ID || "add your session here",
  ...
  BOT_NAME: process.env.BOT_NAME || "Queen Hani",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/kiy0hl.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋ ᴅᴇᴏ",
